  ...
  <div class="publish">
    ...
    <el-form ref="ruleForm" :model="ruleForm" :rules="rules" status-icon label-width="100px" class="demo-ruleForm">
      ...
      <div class="primeArea">
        ...
        <el-form-item label="公司地址" prop="pass">
          <el-input v-model="ruleForm.pass" type="text" />
        </el-form-item>
        <el-form-item label="法人代表" prop="pass">
          <el-input v-model="ruleForm.pass" type="text" />
        </el-form-item>
        <el-form-item label="注册资本" prop="pass">
          <el-input v-model="ruleForm.pass" type="text" />
        </el-form-item>
        <el-form-item label="投资方向" prop="pass">
          <el-input v-model="ruleForm.pass" type="text" />
        </el-form-item>
        ...
        <el-form-item label="资本详情" prop="desc">
          <el-input v-model="ruleForm.pass" :rows="5" type="textarea"/>
        </el-form-item>
        <el-form-item label="发布人" prop="genre">
          <el-select v-model="ruleForm.region" placeholder="请选择发布人">
        ...
        <el-form-item>
          ...
          <el-button @click="$router.go(-1)">预览</el-button>
        </el-form-item>
